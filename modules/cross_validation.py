...
from modules.ensemble import (
    ensemble_predict, evaluate_model, compare_models
)
...
def run_cross_validation(dataset, k=5, seed=42,
    ...
    Pada setiap iterasi i (i = 0, 1, ..., K-1):
      ...
      5. Jalankan Majority Voting Ensemble
    ...
    for i in range(k):
        ...
        rf_model = RandomForestScratch(
            n_trees=rf_params.get('n_trees', 10),
        ...
        # ── 2g: Majority Voting Ensemble ──────────────────────────────────
        # Untuk setiap sampel, ambil suara mayoritas dari 3 model
        ensemble_preds = []
